(function($, global) {
    ...
    var Lottery = {
        ...
        params: {
            ...
            token: null
            // token: '25fec88586cb955f622f7717c1952343'
        },
        config: {
        ...
        setState: function(json) {
            ...
            if ( beginTime > now && verify ) {
                $msg.html('活动还未开始哦~');

                location.hash = '#modal-notify';
            }

            if ( endTime < now && verify ) {
        ...
        saveData: function(amount) {
            ...
            if ( amount <= 0 ) {
                var timeover = 'timeover.html?amount=' + amount;

                location.href = timeover;
            }
    ...
    var Zodiac = {
        ...
        setAmountAnimation: function(amount) {
            ...
            var animateText = new createjs.Text("+" + amount, "34px", "#f7ab33");
